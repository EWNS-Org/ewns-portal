...
function Login() {
    ...
    const [formData, setFormData] = useState({
        ...
        businessDescription: "",
        countryCode: countryList["AF"].dial_code,
        mobileNumber: ""
    });
                            ...
                            </div>
                            {
                                showFirstStep ?
                                    <div style={{ display: "flex", justifyContent: "center", marginTop: "10%" }} className='signup-lef-img'>
                                        <img src="assets/signup-left.svg" height={"425px"} />
                                    </div>
                                    :
                                    <div style={{ display: "flex", justifyContent: "center", marginTop: "10%" }} className='signup-lef-img'>
                                        <img src="assets/signup-second.svg" height={"425px"} />
                                    </div>
                            }
                ...
                <Grid size={6}>
                    <div className='right-signup'>
                        ...
                        <div className='signup-part'>
                            ...
                            <Typography variant='h2' margin="2%">Sign up </Typography>
                        ...
                        <div className='signup-form'>
                            {
                                showFirstStep ?
                                    ...
                                    <div>
                                        ...
                                        <Button onClick={() => handleSignup()} variant='contained' sx={{ width: "60%", height: "15%" }}>Sign up</Button>
