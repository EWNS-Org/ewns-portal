...
const PROVIDER_DESCRIPTIONS: Record<string, string> = {
    GEMINI: 'Google Gemini — Obtain your API key from Google AI Studio.',
    OPENAI: 'OpenAI — Obtain your API key from the OpenAI platform dashboard.',
};
...
export default function AdminAIIntelligence() {
    ...
    const fetchConfigs = useCallback(async () => {
        setLoading(true);
        try {
            const res: any = await getThirdPartyConfigsByCategory('AI_INTELLIGENCE');
    ...
    return (
        <Box>
            ...
            <Typography variant="body2" color="text.secondary" mb={3}>
                Configure and activate an AI provider. Only one can be active at a time.
            </Typography>
